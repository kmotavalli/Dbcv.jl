...
def main():
	...
	if is_medical:
		output = subprocess.run(["julia", f'-t {ncores}', os.path.join(test_scripts_dir, "Tester_PRIM.jl"), dataset_path, classification_path, str(1)], stdout = subprocess.PIPE, universal_newlines = True)
	else:
